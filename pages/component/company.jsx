...
<section className="grid justify-items-center">
  ...
  <h2 className="w-full text-xl font-bold text-center sm:text-2xl md:text-3xl">Experince</h2>
    ...
    <div className="-my-8 divide-y-2 divide-gray-100">
      <div className="py-8 flex flex-wrap md:flex-nowrap">
        <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
          <span className="font-semibold title-font text-gray-700">Padink Engineering Services</span>
          <span className="mt-1 text-gray-500 text-sm">Chennai,Tamilnadu</span>
        </div>
      ...
      <div className="py-8 flex flex-wrap md:flex-nowrap">
        <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
          <span className="font-semibold title-font text-gray-700">Techfully </span>
          <span className="mt-1 text-gray-500 text-sm">Chennai, Tamilnadu</span>
        </div>
        <div className="md:flex-grow">
          <h2 className="text-2xl font-medium text-gray-900 title-font mb-2">React Developer</h2>
          <p className="mt-1 text-gray-500 text-sm">Aug 2021 - Present · 1 yr Experience</p>
          <p className="leading-relaxed"><span className='text-lg font-semibold'>Terv</span>- Terv is an web based application used to create assessments, courses for 
            the training and practicing platform. I have been involved in front-end development in this project and The project required me to learn Typescript for front-end development</p>
            <p className="leading-relaxed pt-5"><span className='text-lg font-semibold'>Docsauth</span> -  Docsauth is an web based application used for digital document process. I worked on the front-end development of this project, which was developed completely in Typescript and React</p>
        </div>
      </div>
    </div>
  </div>
