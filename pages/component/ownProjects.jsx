      ...
      <div className="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
        ...
        <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
          ...
          <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
            ...
            <h3 className="mt-2 text-2xl sm:text-left md:text-4xl">
              Pragi-Prebuilt Tailwind
            </h3>
            <p className="mt-5 text-lg text-gray-700 text md:text-left">
              It is designed and devloped for components that are commonly used
              in our any projects, such as navbars, sidemenus, and alert message
              UIs.
            </p>
            <div className="inline-flex w-40 items-center text-sm font-medium px-8 py-3 mt-8 text-white bg-indigo-600 border border-indigo-600 rounded hover:bg-transparent hover:text-indigo-600 active:text-indigo-500 focus:outline-none focus:ring">
              <Link href="https://pragi.vercel.app/" rel="noopener noreferrer">
                Find Out
              </Link>
              <svg
        ...
        <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
          ...
          <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
            ...
            <p className="mt-5 text-lg text-gray-700 text md:text-left">
              Web design for Electric vehicle company with a vector image and
              some Icons, It Designed flawlessly for seran in Adobe XD with my
        ...
        <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
          ...
          <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
            ...
            <p className="mt-5 text-lg text-gray-700 text md:text-left">
              This project designed and devloped for booking drop taxi via
              whatsapp and phone call, More informations added with cool
              animations.
            </p>
            <div className="inline-flex w-40 items-center text-sm font-medium px-8 py-3 mt-8 text-white bg-indigo-600 border border-indigo-600 rounded hover:bg-transparent hover:text-indigo-600 active:text-indigo-500 focus:outline-none focus:ring">
              <Link
                href="https://www.fivestardroptaxi.in/"
                rel="noopener noreferrer"
              >
                Find Out
              </Link>
        ...
        <div className="flex flex-col mb-8 animated fadeIn sm:flex-row">
          ...
          <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
            ...
            <p className="mt-5 text-lg text-gray-700 text md:text-left">
              {" "}
              Developed for estimate our monthly expenses and give some cool
              advice{" "}
            </p>
            <div className="inline-flex w-40 items-center text-sm font-medium px-8 py-3 mt-8 text-white bg-indigo-600 border border-indigo-600 rounded hover:bg-transparent hover:text-indigo-600 active:text-indigo-500 focus:outline-none focus:ring">
              <Link
