...
useEffect(() => {
    ...
    {
        if (urlCheck.some(e => e.url === domainName)) {
                    ...
                    <div className="flex flex-col">
                        <div className="max-w-3xl mx-auto text-center pt-8">
                            <div
                                ...
                                <Typical loop={Infinity} steps={[ 'Check URL' ,3000, 'Verify Link' ,3000]} />
                            </div>
                            <div>
                                ...
                                <div className="text-center pt-8">
                                    <div>
                                    <div>
                                        {domainStatus == 'good' ? <p className="text-green-600 text-xl">pass</p> : <p
                                            className="text-rose-700 text-xl">fail</p> }
                                    </div>
